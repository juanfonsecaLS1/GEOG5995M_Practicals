...
1. Download the [files of the model](https://github.com/juanfonsecaLS1/GEOG5995M_Practicals/raw/main/model_GUI.zip), copy the model files from the ```model_GUI``` folder into a folder your local drive
